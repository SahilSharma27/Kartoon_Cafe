...
import com.example.android.kartooncafe.ui.home.HomeFragment;
...
//        });
        ...
        int menuBackdropId = intent.getIntExtra(HomeFragment.SPECIAL_BACKDROPID_KEY, 0);
        String menuTitle = intent.getStringExtra(HomeFragment.SPECIAL_TITLE_KEY);
        String menuCategory = intent.getStringExtra(HomeFragment.SPECIAL_CATEGORY_KEY);
        ...
        subMenuRCView.setItemAnimator(new DefaultItemAnimator());
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this);
        subMenuRCView.setLayoutManager(linearLayoutManager);
        adapter2 = new CustomAdapter2(this, clickedMenu);
        subMenuRCView.setAdapter(adapter2);
